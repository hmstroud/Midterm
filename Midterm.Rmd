...
morph <- morph[-c(2:5, 8:10)] %>% na.omit()    #getting rid of NAs
```
...
gs_loglik <- crossing(intercept = seq(-0.15, 0.05, .01),
...
#likelihood
#filter to find max log likelihood
gs_loglik %>% filter(logLik == max(logLik))
